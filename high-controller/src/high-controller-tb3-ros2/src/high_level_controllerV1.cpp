...
class MinimalPublisher : public rclcpp::Node
{
  public:
    ...
    {
      initparam(); //TAMBAHAN DI INITPARAM(); -------------
      ...
      subscriber_ = this->create_subscription<sensor_msgs::msg::LaserScan>(topic, Rio, std::bind(&MinimalPublisher::scanCallback, this, _1)); //subsribe buat ngambil data dari Lidar scan
  ...
  private:
  void initparam(){ //TAMBAHIN LINE (39-46) --------------------
